...
La gestión de un hospital abarca múltiples sectores de la población, y el enfoque en servicios de alta calidad suele estar reservado para los hospitales privados. En este sector, a través de cuotas trimestrales, seguros o planes anuales, los hospitales están obligados a ofrecer servicios con los más altos estándares de calidad. Sin embargo, como se mencionó previamente, el mercado objetivo de estos servicios está limitado por el poder adquisitivo de sus clientes. En consecuencia, la demanda de servicios en hospitales privados no es tan elevada como en el sector público, donde la atención se brinda a un mayor volumen de pacientes.

En el sector público, el nivel de atención está determinado por la capacidad del hospital para atender a un gran número de pacientes, ofreciendo una gama de servicios amplia. Esto incluye la atención a derechohabientes inscritos en el Seguro Social Nacional (SSN), así como la atención de consultas internas y externas. Además, los hospitales públicos tienen el compromiso de atender a aquellos que son canalizados desde otras unidades médicas conectadas a la misma red del seguro social. No obstante, la atención oportuna puede complicarse por la existencia de documentación excesiva y procesos burocráticos que retrasan la atención de pacientes con enfermedades crónicas y degenerativas. Además, la falta de capacitación adecuada del personal puede llevar a la negligencia en el servicio y el manejo de la información de los pacientes.

Los hospitales públicos también suelen estar involucrados en campañas gubernamentales y comunitarias, promoviendo visitas a la comunidad a través de iniciativas como campañas de vacunación, donación de sangre, prevención de enfermedades crónicas, y concienciación sobre enfermedades de transmisión sexual. El sector privado participa en estas campañas al donar material médico y aliarse con las autoridades para mejorar la calidad de vida de las personas más vulnerables. Sin embargo, atender a toda la población vulnerable puede ser un desafío, debido a la gran demanda de servicios médicos de calidad.

En cuanto a los hospitales públicos, estos son administrados por el gobierno, que se encarga de suministrar el material clínico y quirúrgico necesario para la operación y atención de pacientes. No obstante, a menudo se generan desequilibrios en la gestión de los recursos debido a una falta de control adecuado, lo que afecta la eficiencia del servicio. En algunos casos, los médicos, en un esfuerzo por brindar atención de calidad, recurren a comprar insumos por su cuenta. Este problema se deriva de la mala administración de los recursos y la falta de un sistema eficiente que gestione las solicitudes y los suministros hospitalarios.

El sector privado, por otro lado, es financiado por aseguradoras y empresas bancarias, que promueven la contratación de servicios médicos mediante seguros y planes de cobertura. Estas entidades mantienen una relación de "ganar-ganar" con sus clientes, utilizando medios masivos de comunicación para promocionar sus servicios. En algunos casos, realizan actos de responsabilidad social, creando fundaciones para captar donativos y apoyar a personas vulnerables. Estas fundaciones a menudo se especializan en áreas como el tratamiento de enfermedades crónicas (por ejemplo, el cáncer) o de enfermedades de transmisión sexual (como el VIH), buscando mejorar la relación entre el hospital y la comunidad.

En el sector público, las reglas son más estrictas. La operación de los hospitales está sujeta a planeación estratégica basada en estudios epidemiológicos, que identifican las áreas de atención prioritarias. Los pacientes con enfermedades crónicas, adicciones u otros problemas de salud graves son canalizados a áreas especializadas para recibir tratamiento. Sin embargo, debido a la alta demanda, los tiempos de espera pueden ser prolongados. Las autoridades estatales y federales revisan constantemente el funcionamiento del sistema y la gestión de sus procesos.

El cumplimiento de normas estrictas, como las NOM 035 SSA3 2012 y NOM 027 SSA3 2013, es fundamental para la operación de los hospitales públicos. Estas normas establecen los procedimientos para la recolección, procesamiento y divulgación de información en salud, así como los criterios para la atención en servicios de urgencias.

El financiamiento en el sector público está vinculado al presupuesto federal anual, lo que significa que las actualizaciones en infraestructura y servicios dependen de asignaciones presupuestarias anuales o bimestrales. Sin embargo, estas actualizaciones suelen ser insuficientes para satisfacer la demanda creciente. Por ello, es necesario optimizar los procesos de gestión, tales como el manejo de inventarios, documentación y expedientes médicos, gestión de personal y administración de medicamentos. Un sistema digital eficiente que conecte en tiempo real a todas las áreas del hospital podría mejorar significativamente la atención al paciente, asegurando que la información esté debidamente protegida y disponible solo para el personal autorizado.

Finalmente, es crucial implementar medidas robustas de seguridad informática, protegiendo los datos confidenciales de los pacientes mediante encriptación y asegurando que solo el personal autorizado tenga acceso a la información. La implementación de este nivel de seguridad dependerá de las políticas y regulaciones vigentes, pero es esencial para garantizar la privacidad y protección de los datos sensibles.
...
|**Sketch** |**Descripción** |
| - | - |
|**![frontend](img/1Splash.png)** | La propuesta en el diseño de la aplicación ejemplifica una carga previa momentánea, esta se activa inmediatamente al dar apertura a la aplicación permitiendo cargar todos los elementos necesarios para la funcionalidad de la aplicación. |
|**![frontend](img/2Login.png)** | La vista de inicio secundaria permite realizar el logue correspondiente del usuario, sin embargo, se abordará en el diseño la discusión si se le sugiere al usuario dejar su inicio de sesión activa o que introduzca datos de validación en la apertura de las funciones del sistema. |
|**![frontend](img/3Registro%20Personas.png)** |Se necesita un registro previo existente para dar apertura a los permisos por lo que el usuario podrá registrarse a la plataforma con el llenado de sus datos personales, los cuales se resguardarán por el sistema.|
|**![frontend](img/5Menú%20Usuario.png)** |Al existir un registro válido el sistema apertura la información disponible por parte del usuario asignado, en esta vista aparecerá la imagen del usuario con privilegios como las áreas correspondientes para su interacción con los servicios disponibles. |
|**![frontend](img/6Solicitud%20de%20Aprobación.png)** |La vista de solicitudes registrará toda la información necesaria que se requiere para que se asignen los permisos necesarios para la resolución de cada solicitud por los departamentos aledaños a la institución.|
|**![frontend](img/7Estrucutura%20Organica.png)** |La estructura orgánica organiza la distribución de los departamentos hospitalarios y monitoriza permanentemente sus actividades por lo que la dirección general podrá hacer los cambios correspondientes de acuerdo a los criterios que su gestión requiera.|
|**![frontend](img/8Estadistica.png)** |La información recabada del área de dirección general hospitalaria se plasmará con datos históricos en gráficos que permitan evaluar los movimientos realizados en periodos asignados para la modificación y toma de decisiones para la mejora de los departamentos, estos datos permitirán dar las observaciones necesarias para la mejora de servicios hospitalarios.|
|**![frontend](img/9Bitácora.png)** |Cada uno de los registros realizados en la ejecución del sistema se anotará en la bitácora de actividades como control en la asignación de tareas y permisos correspondidos a las áreas de solicitud, evitando conflictos administrativos futuros. |
|**![frontend](img/10Terminos.png)** |Se incluye dentro del desarrollo de la aplicación las normativas legales para poder ejecutar el sistema reasignando responsabilidad y compromiso en la privacidad de la información contenida y la resguarda de datos personales en base a la ley vigente.|
|**![frontend](img/11Acerca.png)** |Se anexa una vista dedicada a los desarrolladores del proyecto donde se especifica de manera breve la versión y el cuerpo de desarrolladores, como los derechos de autor e involucrados en el proyecto. |

|**Wireframes en Figma** |**Descripción** |
| - | - |
|**![frontend](img/Wireframes-DG.png)** |Se ha reestructurado la configuración previa realizada en los bocetos iniciales mencionados en la sección de Skechs. Cada uno ha representado el flujo de la interacción esperada. En esta sección se ha modelado de una manera más interpretativa la colocación de cada uno de los electos que corresponden a imágenes, iconos, casillas y selectores, que den un mejor entendimiento para la maquetación posterior por parte del equipo de desarrollo y facilitara al desarrollador Front-End como debe de interpretarse los elementos. La representación de los módulos se puede consultar en el siguiente enlace. 
