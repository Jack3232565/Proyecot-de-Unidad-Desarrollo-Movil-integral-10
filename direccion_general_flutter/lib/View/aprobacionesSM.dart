import 'package:direccion_general_flutter/login_screean.dart'; // Corrección en el nombre del archivo
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (context) => home.HomeScreen(
                      ...
                      personaId: widget.personaId, // Reemplaza con el valor adecuado
                    ),
                  ),
                );
              },
