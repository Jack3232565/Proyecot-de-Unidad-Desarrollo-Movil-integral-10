...
class BitacoraScreen3 extends StatefulWidget {
  final String area;
  final FacebookUser user;

  BitacoraScreen3({required this.area, required this.user});

  @override
  _BitacoraScreen3State createState() => _BitacoraScreen3State();
}


class _BitacoraScreen3State extends State<BitacoraScreen3> {
