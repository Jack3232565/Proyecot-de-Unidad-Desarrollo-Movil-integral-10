...
class HomeScreen2 extends StatelessWidget {
  ...
  final dynamic user; // Cambiar el tipo a dynamic
  ...
  Widget build(BuildContext context) {
    ...
    if (isGoogleUser) {
      ...
      // Si es un Map de Facebook, obtenemos los datos de allí
      displayName = user['name'] ?? 'No Name';
      email = user['email'] ?? 'No Email';
      photoUrl = user['picture'] ?? ''; // Asegúrate de que 'picture' esté en el mapa
    }
