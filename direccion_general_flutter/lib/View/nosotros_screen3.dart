...
class NosotrosScreen3 extends StatefulWidget {
  final String area;
  final FacebookUser user;

  const NosotrosScreen3({super.key, required this.area, required this.user});

  @override
  _NosotrosScreen3State createState() => _NosotrosScreen3State();
}

class _NosotrosScreen3State extends State<NosotrosScreen3> {
  ...
  void _logout(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) => HomeScreen3(area: widget.area, user: widget.user),
      ),
    );
  }
