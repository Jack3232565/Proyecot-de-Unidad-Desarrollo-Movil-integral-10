...
class TerminosScreen3 extends StatefulWidget {
  final String area;
  final FacebookUser user;

  const TerminosScreen3({super.key, required this.area, required this.user});

  @override
  _TerminosScreen3State createState() => _TerminosScreen3State();
}

class _TerminosScreen3State extends State<TerminosScreen3> {
